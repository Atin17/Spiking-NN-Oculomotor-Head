...
class VisionNodeCenter:
    ...
    def run_node(self):
        ...
        while not rospy.is_shutdown():
            ...
            _, contours, hierarchy = cv2.findContours(laser_point_image, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)
            ...
            for cnt in contours:
                ...
                # if the area is above a certain threshold, consider it a dot
                if area > 15 and area < 200:  # adjust this value based on your requirement
                    dots += 1
            ...
            control_output = [0, 0, 0, 0, dots]  # Up, Down, Left, Right

            #print(laser_point_pixel.shape)

            if laser_point_pixel.shape[0] > 0:
                # while laser_point_pixel is None:
                #     continue
